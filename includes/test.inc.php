...
$sql12 = "SELECT * FROM groups where groupid = $id";
$result12 = $conn->query($sql12);


$sql2 = "SELECT u.userid, u.firstname, u.lastname,u.middlename,m.memberid
    FROM members m 
...
$sql3 = "SELECT * FROM payment where groupid =$id";
...
$sql = "SELECT userid,SUM(debt) as sum FROM userpayment WHERE  groupid = :groupid  GROUP BY userid  ";
    ...
    if ($result->rowCount() > 0) {
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
            ...
            <?php while ($row10 = $stmt10->fetchall(PDO::FETCH_ASSOC)) {
                ...
                $sql = "SELECT userid,SUM(amount) as sum FROM payment WHERE  groupid = :groupid  GROUP BY userid";
               ...
               // echo '<pre>', print_r($array), '</pre>';
                ...
                <div class="col col-1" data-label="Job Id"><?= $new[$i]['sum'] ?></div></li><?php $i++; } ?><br>





        <br><div class="col col-1" data-label="Job Id"></div>
    <?php } ?>
    <li class="table-header">
